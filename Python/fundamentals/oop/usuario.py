...
usuario_1.hacer_deposito(400)
usuario_1.hacer_deposito(600)
usuario_1.hacer_retiro(500)
...
usuario_1.transferir_dinero(usuario_3, 200)
usuario_1.mostrar_balance_usuario()
usuario_3.mostrar_balance_usuario()